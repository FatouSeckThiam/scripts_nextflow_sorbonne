...
process RunStrelka2{
	...
	output:
	tuple val(norm), path("./${norm}_strelka2/results/variants/somatic.indels.vcf.gz"), path("./${norm}_strelka2/results/variants/somatic.indels.vcf.gz.tbi"), path ("./${norm}_strelka.indels.pass.vcf"), path("./${norm}_strelka2/results/variants/somatic.snvs.vcf.gz"), path("./${norm}_strelka2/results/variants/somatic.snvs.vcf.gz.tbi") into strelka2_variants_ch
