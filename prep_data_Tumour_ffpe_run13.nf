...
//params.Tumlist = "/home/seck-thiam/sampleliste_tum_ffpe_wes_run13_prep_data"
params.Tumlist = "/home/seck-thiam/FR-01-171_liste_prep"
params.inputDir = "/SCVOL02/Novaseq_exomes_220719_karim/FFPE/fastq"
...
params.outDir_Fastp = "/SCVOL02/run_13/exome/Fastp"
params.outDir_Bam = "/SCVOL02/run_13/exome/Bam"
params.outDir_QCmetrics = "/SCVOL02/run_13/exome/Bam/QCmetrics"
params.cpus = 5
params.help=false
...
samplist_Tumour.withReader {
    ...
    while( line = reader.readLine() ) {
        String id_fastq1_tum = line.split("\t")[1].replaceAll(".fastq.gz","")
        String id_fastq2_tum = line.split("\t")[2].replaceAll(".fastq.gz","")
        String fq1_tum = line.split("\t")[1]
        String fq2_tum = line.split("\t")[2]
