...
params.Germlist = "/home/seck-thiam/run_11_samples_files_Germline.txt"
params.inputDir = "/SCVOL02/ideation_raw_data/Data_transfer_globus_18_02_22/Novaseq_170222_Bouzidi_EXOMES/fastq"
...
params.refGenome_targets_list="/home/seck-thiam/Twist_ComprehensiveExome_targets_hg38.bed.gz" 
params.outDir_Fastp = "/SCVOL02/run_11/exome/Fastp/Germline"
params.outDir_Bam = "/SCVOL02/run_13/exome/Bam"
params.outDir_QCmetrics = "/SCVOL02/run_13/Bam/QCmetrics"
params.cpus = 5
params.help=false
...
samplist_Germline.withReader {
    ...
    while( line = reader.readLine() ) {
        String id_fastq1_germ = line.split("\t")[3].replaceAll(".fastq.gz","")
        String id_fastq2_germ = line.split("\t")[4].replaceAll(".fastq.gz","")
        String fq1_germ = line.split("\t")[3]
	String fq2_germ = line.split("\t")[4]
