...
params.samplelist = "/home/seck-thiam/samplelist_run6"
...
process MergeMutectStrelka{
	...
	"""
	java -jar \$PICARD MergeVcfs INPUT=!{mutect1_strelka2[3][0]} INPUT=!{mutect1_strelka2[3][-1]} OUTPUT=./!{norm}_snv.indels.wes.variants.vcf
