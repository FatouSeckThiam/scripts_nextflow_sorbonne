...
params.outDir_Fastp = "/SCVOL02/run_13/rnaseq/Fastp
"
...
samplist_rna.withReader {
    ...
    while( line = reader.readLine() ) {
        String id_fastq1 = line.split("\t")[2].replaceAll("_R1_001.fastq.gz","")
        String id_fastq2 = line.split("\t")[3].replaceAll("_R2_001.fastq.gz","")
        String fq1= line.split("\t")[2]
        String fq2 = line.split("\t")[3]
