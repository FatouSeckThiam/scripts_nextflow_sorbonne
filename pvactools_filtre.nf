...
params.samples = "/home/seck-thiam/samplelist_90_91_run10_filtre"
//params.inputDir = "/SCVOL02/run_10/neoepitope_pvactools/2.0.1/Germline"
params.inputDir = "/SCVOL02/ideation_mutation/vcf_for_neo/converted/neoepitope_wes_results"
params.outDir = "/SCVOL02/run_10/neoepitope_pvactools/2.0.1/Germline/filtre_ideation"
params.outDir_pep ="/SCVOL02/run_10/neoepitope_pvactools/2.0.1/Germline/peptide"
...
samplelist.withReader() {
	...
	String id_tsv = line.split("_")[0]
        //String tsv = line.split("\t")[0]	
	tsv_file = "${params.inputDir}/"+id_tsv +"_wes"+"/combined/"+ id_tsv+"_Tumour.all_epitopes.aggregated.tsv"
